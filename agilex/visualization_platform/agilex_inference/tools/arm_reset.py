...
# LEFT0 = [0, 0.0, 0.0, 0.02, 0.43, 0.0, 0.1]
# RIGHT0 = [0, 0.0, 0.0, 0.02, 0.43, 0.0, 0.1]
# LEFT_RESET = [0, 0.32, -0.36, 0, 0.24, 0, 0.1]
# RIGHT_RESET = [0, 0.32, -0.36, 0, 0.24, 0, 0.1]
HOME_POSITIONS = [
    [0, 0.0, 0.0, 0.02, 0.43, 0.0, 0.1],
    [0, 0.32, -0.36, 0, 0.24, 0, 0.1]
]
...
class ArmHomeOperator:
    ...
    def arm_home(self, left_home=HOME_POSITIONS[0], right_home=HOME_POSITIONS[0]):
        """
...
def main():
    ...
    try:
        ...
        # 从日志文件获取最后的主臂位置（如果有）
        position = HOME_POSITIONS[args.mode]
        arm_operator.arm_home(position, position)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="机器人手臂回归0点脚本")
    parser.add_argument("mode", type=int, default=0, help="回归模式：0-回归到预设0点位置，1-复位到推理初始位置")
